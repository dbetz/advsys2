...
static int Assemble(ParseContext *c)
{
    ...
    AddSymbol(c, "tos",         SYMBOL_VALUE, 0x001);
    AddSymbol(c, "sp",          SYMBOL_VALUE, 0x002);
    AddSymbol(c, "fp",          SYMBOL_VALUE, 0x003);
    AddSymbol(c, "pc",          SYMBOL_VALUE, 0x004);
    AddSymbol(c, "efp",         SYMBOL_VALUE, 0x005);
    AddSymbol(c, "_stepping",   SYMBOL_VALUE, 0x006);
    AddSymbol(c, "_stack",      SYMBOL_VALUE, 0x007);
    AddSymbol(c, "_stackTop",   SYMBOL_VALUE, 0x008);
    AddSymbol(c, "_dbase",      SYMBOL_VALUE, 0x009);
    AddSymbol(c, "_cbase",      SYMBOL_VALUE, 0x00a);
    AddSymbol(c, "t1",          SYMBOL_VALUE, 0x00b);
    AddSymbol(c, "t2",          SYMBOL_VALUE, 0x00c);
    AddSymbol(c, "t3",          SYMBOL_VALUE, 0x00d);
    AddSymbol(c, "t4",          SYMBOL_VALUE, 0x00e);
